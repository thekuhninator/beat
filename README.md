...
The path to the parent directory holding other folders containing .beat log files. multi_beat checks all subfolders recursively and will use every .beat file it finds in the report.
